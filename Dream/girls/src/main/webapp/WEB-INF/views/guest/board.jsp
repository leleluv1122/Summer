					...
					<hr /> <form:form method="post" modelAttribute="board">
						...
						<div class="form-group">
							...
							<sec:authorize access="not authenticated">
								<form:input path="writer" value="guest" readonly="true"  class="form-control w200" />
							</sec:authorize>
							<sec:authorize access="authenticated">
								<sec:authentication property="user.name" var="currentname" />
								<form:input path="writer" value="${currentname}" readonly="true" class="form-control w200" />
							</sec:authorize>
						</div>
						<div class="form-group">
							<label>내용:</label>
