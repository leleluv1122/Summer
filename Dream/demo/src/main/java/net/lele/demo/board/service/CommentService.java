...
import net.lele.demo.board.mapper.CommentMapper;

@Service("net.lele.demo.board.service.CommentService")
public class CommentService {

    @Resource(name="net.lele.demo.board.mapper.CommentMapper")
