...
<body>
	<table align="center" bgcolor='#CCE3C6'>
		...
		<table align="center" bgcolor='#CCE3C6'>
			<tr>
				<td align="center" bgcolor='#CCE3C6' height='18' valign='bottom'
					colspan="7"><a
					href='calendar.jsp?year=<%=cal.get(Calendar.YEAR)%>&month=<%=((cal.get(Calendar.MONTH) + 1) - 1)%>'><font
						color='484848' size='2'>◀ </font></a><font color='484848' size='2'><%=cal.get(Calendar.YEAR)%>
						/ <%=(cal.get(Calendar.MONTH) + 1)%> </font><a
					href='calendar.jsp?year=<%=cal.get(Calendar.YEAR)%>&month=<%=((cal.get(Calendar.MONTH) + 1) + 1)%>'><font
						color='484848' size='2'>▶ </font></a></td>
			</tr>
